...
const TermsOfServiseComponent = () => {
  return (
    <Box w="100%">
      ...
      <Box mb="8px" />
      <NormalText>
        This website is operated by Merchadise Inc. Throughout the site, the
        terms “we”, “us” and “our” refer to Merchadise Inc. This website,
        including all information, tools and Services available from this site
        to you, the user, is conditioned upon your acceptance of all terms,
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 1 - ONLINE STORE TERMS</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 2 - GENERAL CONDITIONS</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 7 - OPTIONAL TOOLS</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 8 - THIRD-PARTY LINKS</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 10 - PERSONAL INFORMATION</Text700>
      <Box mb="8px" />
      <NormalText>
        Your submission of personal information through the store is governed by
        our Privacy Policy, which can be viewed by clicking on the Privacy
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 12 -  PROHIBITED USES</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <NormalText>
        ...
        shall Merchadise,, our directors, officers, employees, affiliates,
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 14 - INDEMNIFICATION</Text700>
      <Box mb="8px" />
      <NormalText>
        You agree to indemnify, defend and hold harmless Merchadise and our
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 15 - SEVERABILITY</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 16 - TERMINATION</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 17 - ENTIRE AGREEMENT</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 18 - GOVERNING LAW</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">SECTION 20 - CONTACT INFORMATION</Text700>
      <Box mb="8px" />
      <NormalText>
        Questions about the Terms of Service should be sent to us at:  <br />
        support@merchadise.com.
        <br />
        <br />
...
export default TermsOfServiseComponent;
