...
const PrivacyComponent = () => {
  return (
    <Box w="100%">
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Contact</Text700>
      <Box mb="8px" />
      <NormalText>
        ...
        complaint, please contact us by e-mail at support@merchadise.com or by
        mail using the details provided below: 1525 SE 57th Ave Portland OR
        97215, United States/
      </NormalText>
      <Box mb="16px" />
      <Text700 fontSize="24px">Collecting Personal Information</Text700>
      <Box mb="8px" />
      <NormalText>
        ...
        <ul>
          ...
          <li>
            Purpose of collection: to provide customer support services to you.
          </li>
          <li>Source of collection: collected from you.</li>
          <li>
            Disclosure for a business purpose: shared with our processor
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Minors</Text700>
      <Box mb="8px" />
      <NormalText>
        The Site is not intended for individuals under the age of 16. We do not
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Sharing Personal Information</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Behavioural Advertising</Text700>
      <Box mb="8px" />
      <NormalText>
        ...
        interest to you. For example:  We use Google Analytics to help us
        ...
        of Google Analytics here: https://tools.google.com/dlpage/gaoptout. We
        share information about your use of the Site, your purchases, and your
        ...
        your location). We use Shopify Audiences to help us show ads on other
        websites with our advertising partners to buyers who made purchases with
        other Shopify merchants and who may also be interested in what we have
        to offer. We also share information about your use of the Site, your
        purchases, and the email address associated with your purchases with
        Shopify Audiences, through which other Shopify merchants may make offers
        you may be interested in. For more information about how targeted
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Using Personal Information</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Lawful basis</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Retention</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Automatic decision-making</Text700>
      <Box mb="8px" />
      <NormalText>
        ...
        otherwise significantly affects you. We DO NOT engage in fully automated
        decision-making that has a legal or otherwise significant effect using
        customer data. Our processor Shopify uses limited automated
        decision-making to prevent fraud that does not have a legal or otherwise
        significant effect on you. Services that include elements of automated
        decision-making include: Temporary blacklist of IP addresses associated
        with repeated failed transactions. This blacklist persists for a small
        number of hours. Temporary blacklist of credit cards associated with
      ...
      <NormalText>
        ...
        the contact information above. Then will be transferred outside of
        ...
        the GDPR, see Shopify’s GDPR Whitepaper:
        https://help.shopify.com/en/manual/your-account/privacy/GDPR.
      </NormalText>

      <Box mb="16px" />
      <Text700 fontSize="24px">CCPA</Text700>
      <Box mb="8px" />
      <NormalText>
      ...
      <Box mb="16px" />
      <Text700 fontSize="24px">Cookies</Text700>
      <Box mb="8px" />
      <NormalText>
